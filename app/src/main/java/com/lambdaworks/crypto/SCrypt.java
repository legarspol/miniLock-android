...
import com.uliamar.minilock.minilocklib.crypto.PBKDF;
...
//  }
  ...
  static { System.loadLibrary("scrypt"); }
...
//    return native_library_loaded ? scryptN(passwd, salt, N, r, p, dkLen) : scryptJ(passwd, salt, N, r, p, dkLen);
  ...
  // TODO: 31/12/15 What happen if there is no implementation of scrypt for this architecture ?
